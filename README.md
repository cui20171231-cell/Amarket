...
第254号收盘节点从15:00开始失败后每分钟重试，最晚重试到北京时间16:00。16:00 日K使用同一常驻服务里的独立执行通道。普通失败每10分钟重试，
最晚到下一交易准备日 08:30；服务在16:00后重启会检查并补跑未成功的当日日K，在次日08:30前
重启会检查前一日是否需要补跑。复权事件仍只在周一随日K任务执行。

服务在08:55、09:00、09:10、09:16、15:05、16:05和16:30检查交易日确认、两张计划表、
