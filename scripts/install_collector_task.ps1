...
Register-ScheduledTask -TaskName $taskName -Action $taskAction -Trigger $bootTrigger -Settings $taskSettings -Principal $taskPrincipal -Description "Always-on Hithink collector. It starts with Windows and keeps the fixed 254-node plan online." -Force
