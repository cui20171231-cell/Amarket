...
continuous_pm    13:00:15 - 14:56:15，每分钟，117 行
auction_close    14:56:55、14:57、14:58、14:59、15:00，5 行
```

因此，完整交易日目标为 254 行；某个快照节点未成功采到，就不创建该状态行，绝不补造。
...
所以 09:15、09:30:15、13:00:15、14:56:55、14:57 的一分钟字段必为 `NULL`；14:58、14:59、15:00 可以正常计算。
