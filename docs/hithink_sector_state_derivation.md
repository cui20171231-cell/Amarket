...
| 编号 | 计划时间 |
|---|---|
| `001-011` | 09:15:00-09:25:00，每分钟 |
| `012-132` | 09:30:15-11:30:15，每分钟 |
| `133-249` | 13:00:15-14:56:15，每分钟 |
| `250-254` | 14:56:55、14:57:00、14:58:00、14:59:00、15:00:00 |
...
首次初始化只允许写当前交易日的 `254` 号收盘最终节点，绝不倒推 14:xx 的盘中历史。计划时间保持 `15:00:00`；API 实际返回时间写入 `source_time`。
