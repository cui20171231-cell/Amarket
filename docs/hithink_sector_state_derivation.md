...
| `250-254` | 14:56:53、14:57:08、14:58:08、14:59:08、15:00:08（自2026-09-04起） |
...
首次初始化只允许写当前交易日的 `254` 号收盘最终节点，绝不倒推 14:xx 的盘中历史。自2026-09-04起计划时间为 `15:00:08`；API 实际返回时间写入 `source_time`。
