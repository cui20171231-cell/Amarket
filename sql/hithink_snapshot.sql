...
-- Before schedule V3, node 254 is the formal 15:00 close. A tables must contain a new post-close
...
-- From 2026-09-04, collect the four closing-auction snapshots at second 08.
-- Historical rows retain their original second 00 schedule.
ALTER TABLE market.hithink_market_delta_15m DROP CONSTRAINT IF EXISTS ck_market_delta_business_period;
ALTER TABLE market.hithink_market_delta_15m ADD CONSTRAINT IF NOT EXISTS ck_market_delta_business_period CHECK
    (trade_date < toDate('2026-09-02') AND tuple(node_seq, toHour(scheduled_time) * 3600 + toMinute(scheduled_time) * 60 + toSecond(scheduled_time)) IN ((11, 33915), (12, 34215), (27, 35115), (42, 36015), (57, 36915), (72, 37815), (87, 38715), (102, 39615), (117, 40515), (132, 41415), (133, 46815), (148, 47715), (163, 48615), (178, 49515), (193, 50415), (208, 51315), (223, 52215), (238, 53115), (254, 54000)))
    OR (trade_date >= toDate('2026-09-02') AND trade_date < toDate('2026-09-04') AND tuple(node_seq, toHour(scheduled_time) * 3600 + toMinute(scheduled_time) * 60 + toSecond(scheduled_time)) IN ((11, 33908), (12, 34208), (27, 35108), (42, 36008), (57, 36908), (72, 37808), (87, 38708), (102, 39608), (117, 40508), (132, 41408), (133, 46808), (148, 47708), (163, 48608), (178, 49508), (193, 50408), (208, 51308), (223, 52208), (238, 53108), (254, 54000)))
    OR (trade_date >= toDate('2026-09-04') AND trade_date < toDate('2026-09-14') AND tuple(node_seq, toHour(scheduled_time) * 3600 + toMinute(scheduled_time) * 60 + toSecond(scheduled_time)) IN ((11, 33908), (12, 34208), (27, 35108), (42, 36008), (57, 36908), (72, 37808), (87, 38708), (102, 39608), (117, 40508), (132, 41408), (133, 46808), (148, 47708), (163, 48608), (178, 49508), (193, 50408), (208, 51308), (223, 52208), (238, 53108), (254, 54008)))
    OR (trade_date >= toDate('2026-09-14') AND tuple(node_seq, toHour(scheduled_time) * 3600 + toMinute(scheduled_time) * 60 + toSecond(scheduled_time)) IN ((11, 33908), (12, 34208), (27, 35108), (42, 36008), (57, 36908), (72, 37808), (87, 38708), (102, 39608), (117, 40508), (132, 41408), (133, 46808), (148, 47708), (163, 48608), (178, 49508), (193, 50408), (208, 51308), (223, 52208), (238, 53108), (254, 55808)));

ALTER TABLE market.hithink_market_delta_15m DROP CONSTRAINT IF EXISTS ck_market_delta_closing_254;
ALTER TABLE market.hithink_market_delta_15m ADD CONSTRAINT IF NOT EXISTS ck_market_delta_closing_254 CHECK node_seq != 254 OR (toDate(scheduled_time) = trade_date AND ((trade_date < toDate('2026-09-04') AND toHour(scheduled_time) = 15 AND toMinute(scheduled_time) = 0 AND toSecond(scheduled_time) = 0) OR (trade_date >= toDate('2026-09-04') AND trade_date < toDate('2026-09-14') AND toHour(scheduled_time) = 15 AND toMinute(scheduled_time) = 0 AND toSecond(scheduled_time) = 8) OR (trade_date >= toDate('2026-09-14') AND toHour(scheduled_time) = 15 AND toMinute(scheduled_time) = 30 AND toSecond(scheduled_time) = 8)) AND delta_status = 'VALID' AND state_data_status = 'CURRENT' AND state_source_collection_id = collection_id AND state_source_scheduled_time = scheduled_time AND state_source_age_seconds = 0 AND state_is_fallback = 0 AND base_scheduled_time >= toDateTime64(concat(toString(trade_date), ' 13:00:00'), 3, 'Asia/Shanghai') AND base_scheduled_time < scheduled_time AND base_age_seconds > 0 AND calculated_at >= scheduled_time);

ALTER TABLE market.hithink_snapshot_raw DROP CONSTRAINT IF EXISTS ck_snapshot_raw_closing_254;
ALTER TABLE market.hithink_snapshot_raw ADD CONSTRAINT IF NOT EXISTS ck_snapshot_raw_closing_254 CHECK node_seq != 254 OR (toDate(scheduled_time) = trade_date AND ((trade_date < toDate('2026-09-04') AND toHour(scheduled_time) = 15 AND toMinute(scheduled_time) = 0 AND toSecond(scheduled_time) = 0) OR (trade_date >= toDate('2026-09-04') AND trade_date < toDate('2026-09-14') AND toHour(scheduled_time) = 15 AND toMinute(scheduled_time) = 0 AND toSecond(scheduled_time) = 8) OR (trade_date >= toDate('2026-09-14') AND toHour(scheduled_time) = 15 AND toMinute(scheduled_time) = 30 AND toSecond(scheduled_time) = 8)) AND ((trade_date < toDate('2026-09-14') AND source_time >= scheduled_time - INTERVAL 60 SECOND) OR (trade_date >= toDate('2026-09-14') AND source_time >= scheduled_time - INTERVAL 31 MINUTE)) AND ingest_time >= scheduled_time);
ALTER TABLE market.hithink_sector_index_snapshot DROP CONSTRAINT IF EXISTS ck_sector_index_closing_254;
ALTER TABLE market.hithink_sector_index_snapshot ADD CONSTRAINT IF NOT EXISTS ck_sector_index_closing_254 CHECK node_seq != 254 OR (toDate(scheduled_time) = trade_date AND ((trade_date < toDate('2026-09-04') AND toHour(scheduled_time) = 15 AND toMinute(scheduled_time) = 0 AND toSecond(scheduled_time) = 0) OR (trade_date >= toDate('2026-09-04') AND trade_date < toDate('2026-09-14') AND toHour(scheduled_time) = 15 AND toMinute(scheduled_time) = 0 AND toSecond(scheduled_time) = 8) OR (trade_date >= toDate('2026-09-14') AND toHour(scheduled_time) = 15 AND toMinute(scheduled_time) = 30 AND toSecond(scheduled_time) = 8)) AND ((trade_date < toDate('2026-09-14') AND source_time >= scheduled_time - INTERVAL 60 SECOND) OR (trade_date >= toDate('2026-09-14') AND source_time >= scheduled_time - INTERVAL 31 MINUTE)) AND ingest_time >= scheduled_time);
ALTER TABLE market.hithink_limit_up_pool DROP CONSTRAINT IF EXISTS ck_limit_up_closing_254;
ALTER TABLE market.hithink_limit_up_pool ADD CONSTRAINT IF NOT EXISTS ck_limit_up_closing_254 CHECK node_seq != 254 OR (scheduled_time IS NOT NULL AND toDate(scheduled_time) = trade_date AND ((trade_date < toDate('2026-09-04') AND toHour(scheduled_time) = 15 AND toMinute(scheduled_time) = 0 AND toSecond(scheduled_time) = 0) OR (trade_date >= toDate('2026-09-04') AND trade_date < toDate('2026-09-14') AND toHour(scheduled_time) = 15 AND toMinute(scheduled_time) = 0 AND toSecond(scheduled_time) = 8) OR (trade_date >= toDate('2026-09-14') AND toHour(scheduled_time) = 15 AND toMinute(scheduled_time) = 30 AND toSecond(scheduled_time) = 8)) AND ((trade_date < toDate('2026-09-14') AND source_time >= scheduled_time - INTERVAL 60 SECOND) OR (trade_date >= toDate('2026-09-14') AND source_time >= scheduled_time - INTERVAL 31 MINUTE)) AND ingest_time >= scheduled_time);
ALTER TABLE market.hithink_limit_down_pool DROP CONSTRAINT IF EXISTS ck_limit_down_closing_254;
ALTER TABLE market.hithink_limit_down_pool ADD CONSTRAINT IF NOT EXISTS ck_limit_down_closing_254 CHECK node_seq != 254 OR (scheduled_time IS NOT NULL AND toDate(scheduled_time) = trade_date AND ((trade_date < toDate('2026-09-04') AND toHour(scheduled_time) = 15 AND toMinute(scheduled_time) = 0 AND toSecond(scheduled_time) = 0) OR (trade_date >= toDate('2026-09-04') AND trade_date < toDate('2026-09-14') AND toHour(scheduled_time) = 15 AND toMinute(scheduled_time) = 0 AND toSecond(scheduled_time) = 8) OR (trade_date >= toDate('2026-09-14') AND toHour(scheduled_time) = 15 AND toMinute(scheduled_time) = 30 AND toSecond(scheduled_time) = 8)) AND ((trade_date < toDate('2026-09-14') AND source_time >= scheduled_time - INTERVAL 60 SECOND) OR (trade_date >= toDate('2026-09-14') AND source_time >= scheduled_time - INTERVAL 31 MINUTE)) AND ingest_time >= scheduled_time);
ALTER TABLE market.hithink_limit_break_pool DROP CONSTRAINT IF EXISTS ck_limit_break_closing_254;
ALTER TABLE market.hithink_limit_break_pool ADD CONSTRAINT IF NOT EXISTS ck_limit_break_closing_254 CHECK node_seq != 254 OR (toDate(scheduled_time) = trade_date AND ((trade_date < toDate('2026-09-04') AND toHour(scheduled_time) = 15 AND toMinute(scheduled_time) = 0 AND toSecond(scheduled_time) = 0) OR (trade_date >= toDate('2026-09-04') AND trade_date < toDate('2026-09-14') AND toHour(scheduled_time) = 15 AND toMinute(scheduled_time) = 0 AND toSecond(scheduled_time) = 8) OR (trade_date >= toDate('2026-09-14') AND toHour(scheduled_time) = 15 AND toMinute(scheduled_time) = 30 AND toSecond(scheduled_time) = 8)) AND ((trade_date < toDate('2026-09-14') AND source_time >= scheduled_time - INTERVAL 60 SECOND) OR (trade_date >= toDate('2026-09-14') AND source_time >= scheduled_time - INTERVAL 31 MINUTE)) AND ingest_time >= scheduled_time);

ALTER TABLE market.hithink_snapshot_derived DROP CONSTRAINT IF EXISTS ck_snapshot_derived_closing_254;
ALTER TABLE market.hithink_snapshot_derived ADD CONSTRAINT IF NOT EXISTS ck_snapshot_derived_closing_254 CHECK node_seq != 254 OR (toDate(scheduled_time) = trade_date AND ((trade_date < toDate('2026-09-04') AND toHour(scheduled_time) = 15 AND toMinute(scheduled_time) = 0 AND toSecond(scheduled_time) = 0) OR (trade_date >= toDate('2026-09-04') AND trade_date < toDate('2026-09-14') AND toHour(scheduled_time) = 15 AND toMinute(scheduled_time) = 0 AND toSecond(scheduled_time) = 8) OR (trade_date >= toDate('2026-09-14') AND toHour(scheduled_time) = 15 AND toMinute(scheduled_time) = 30 AND toSecond(scheduled_time) = 8)) AND ((trade_date < toDate('2026-09-14') AND source_time >= scheduled_time - INTERVAL 60 SECOND) OR (trade_date >= toDate('2026-09-14') AND source_time >= scheduled_time - INTERVAL 31 MINUTE)) AND ingest_time >= scheduled_time);
ALTER TABLE market.hithink_market_state DROP CONSTRAINT IF EXISTS ck_market_state_closing_254;
ALTER TABLE market.hithink_market_state ADD CONSTRAINT IF NOT EXISTS ck_market_state_closing_254 CHECK node_seq != 254 OR (toDate(scheduled_time) = trade_date AND ((trade_date < toDate('2026-09-04') AND toHour(scheduled_time) = 15 AND toMinute(scheduled_time) = 0 AND toSecond(scheduled_time) = 0) OR (trade_date >= toDate('2026-09-04') AND trade_date < toDate('2026-09-14') AND toHour(scheduled_time) = 15 AND toMinute(scheduled_time) = 0 AND toSecond(scheduled_time) = 8) OR (trade_date >= toDate('2026-09-14') AND toHour(scheduled_time) = 15 AND toMinute(scheduled_time) = 30 AND toSecond(scheduled_time) = 8)) AND ((trade_date < toDate('2026-09-14') AND source_time >= scheduled_time - INTERVAL 60 SECOND) OR (trade_date >= toDate('2026-09-14') AND source_time >= scheduled_time - INTERVAL 31 MINUTE)) AND calculated_at >= scheduled_time);
ALTER TABLE market.hithink_emotion_state DROP CONSTRAINT IF EXISTS ck_emotion_closing_254_freshness;
ALTER TABLE market.hithink_emotion_state ADD CONSTRAINT IF NOT EXISTS ck_emotion_closing_254_freshness CHECK node_seq != 254 OR (toDate(scheduled_time) = trade_date AND ((trade_date < toDate('2026-09-04') AND toHour(scheduled_time) = 15 AND toMinute(scheduled_time) = 0 AND toSecond(scheduled_time) = 0) OR (trade_date >= toDate('2026-09-04') AND trade_date < toDate('2026-09-14') AND toHour(scheduled_time) = 15 AND toMinute(scheduled_time) = 0 AND toSecond(scheduled_time) = 8) OR (trade_date >= toDate('2026-09-14') AND toHour(scheduled_time) = 15 AND toMinute(scheduled_time) = 30 AND toSecond(scheduled_time) = 8)) AND pool_data_status = 'CURRENT' AND pool_source_collection_id = collection_id AND pool_source_scheduled_time = scheduled_time AND pool_source_age_seconds = 0 AND pool_is_fallback = 0 AND calculated_at >= scheduled_time);
ALTER TABLE market.hithink_concept_state DROP CONSTRAINT IF EXISTS ck_concept_state_closing_254;
ALTER TABLE market.hithink_concept_state ADD CONSTRAINT IF NOT EXISTS ck_concept_state_closing_254 CHECK node_seq != 254 OR (toDate(scheduled_time) = trade_date AND ((trade_date < toDate('2026-09-04') AND toHour(scheduled_time) = 15 AND toMinute(scheduled_time) = 0 AND toSecond(scheduled_time) = 0) OR (trade_date >= toDate('2026-09-04') AND trade_date < toDate('2026-09-14') AND toHour(scheduled_time) = 15 AND toMinute(scheduled_time) = 0 AND toSecond(scheduled_time) = 8) OR (trade_date >= toDate('2026-09-14') AND toHour(scheduled_time) = 15 AND toMinute(scheduled_time) = 30 AND toSecond(scheduled_time) = 8)) AND ((trade_date < toDate('2026-09-14') AND stock_source_time >= scheduled_time - INTERVAL 60 SECOND AND index_source_time IS NOT NULL AND index_source_time >= scheduled_time - INTERVAL 60 SECOND) OR (trade_date >= toDate('2026-09-14') AND stock_source_time >= scheduled_time - INTERVAL 31 MINUTE AND index_source_time IS NOT NULL AND index_source_time >= scheduled_time - INTERVAL 31 MINUTE)) AND calculated_at >= scheduled_time);
ALTER TABLE market.hithink_industry_state DROP CONSTRAINT IF EXISTS ck_industry_state_closing_254;
ALTER TABLE market.hithink_industry_state ADD CONSTRAINT IF NOT EXISTS ck_industry_state_closing_254 CHECK node_seq != 254 OR (toDate(scheduled_time) = trade_date AND ((trade_date < toDate('2026-09-04') AND toHour(scheduled_time) = 15 AND toMinute(scheduled_time) = 0 AND toSecond(scheduled_time) = 0) OR (trade_date >= toDate('2026-09-04') AND trade_date < toDate('2026-09-14') AND toHour(scheduled_time) = 15 AND toMinute(scheduled_time) = 0 AND toSecond(scheduled_time) = 8) OR (trade_date >= toDate('2026-09-14') AND toHour(scheduled_time) = 15 AND toMinute(scheduled_time) = 30 AND toSecond(scheduled_time) = 8)) AND ((trade_date < toDate('2026-09-14') AND stock_source_time >= scheduled_time - INTERVAL 60 SECOND AND index_source_time IS NOT NULL AND index_source_time >= scheduled_time - INTERVAL 60 SECOND) OR (trade_date >= toDate('2026-09-14') AND stock_source_time >= scheduled_time - INTERVAL 31 MINUTE AND index_source_time IS NOT NULL AND index_source_time >= scheduled_time - INTERVAL 31 MINUTE)) AND calculated_at >= scheduled_time);
ALTER TABLE market.hithink_style_state DROP CONSTRAINT IF EXISTS ck_style_state_closing_254;
ALTER TABLE market.hithink_style_state ADD CONSTRAINT IF NOT EXISTS ck_style_state_closing_254 CHECK node_seq != 254 OR (toDate(scheduled_time) = trade_date AND ((trade_date < toDate('2026-09-04') AND toHour(scheduled_time) = 15 AND toMinute(scheduled_time) = 0 AND toSecond(scheduled_time) = 0) OR (trade_date >= toDate('2026-09-04') AND trade_date < toDate('2026-09-14') AND toHour(scheduled_time) = 15 AND toMinute(scheduled_time) = 0 AND toSecond(scheduled_time) = 8) OR (trade_date >= toDate('2026-09-14') AND toHour(scheduled_time) = 15 AND toMinute(scheduled_time) = 30 AND toSecond(scheduled_time) = 8)) AND ((trade_date < toDate('2026-09-14') AND stock_source_time >= scheduled_time - INTERVAL 60 SECOND AND index_source_time IS NOT NULL AND index_source_time >= scheduled_time - INTERVAL 60 SECOND) OR (trade_date >= toDate('2026-09-14') AND stock_source_time >= scheduled_time - INTERVAL 31 MINUTE AND index_source_time IS NOT NULL AND index_source_time >= scheduled_time - INTERVAL 31 MINUTE)) AND calculated_at >= scheduled_time);
...
(
    ...
    CONSTRAINT ck_auction_snapshot_node_seq CHECK node_seq BETWEEN 1 AND 11 OR (trade_date < toDate('2026-09-14') AND node_seq BETWEEN 251 AND 254) OR (trade_date >= toDate('2026-09-14') AND node_seq BETWEEN 250 AND 254),
    CONSTRAINT ck_auction_snapshot_closing_254 CHECK node_seq != 254 OR (trade_date < toDate('2026-09-04') AND toHour(scheduled_time) = 15 AND toMinute(scheduled_time) = 0 AND toSecond(scheduled_time) = 0) OR (trade_date >= toDate('2026-09-04') AND trade_date < toDate('2026-09-14') AND toHour(scheduled_time) = 15 AND toMinute(scheduled_time) = 0 AND toSecond(scheduled_time) = 8) OR (trade_date >= toDate('2026-09-14') AND toHour(scheduled_time) = 15 AND toMinute(scheduled_time) = 30 AND toSecond(scheduled_time) = 8)
)
ENGINE = ReplacingMergeTree(version_time)
PARTITION BY toYYYYMM(trade_date)
ORDER BY (trade_date, collection_id, thscode);
...
ALTER TABLE market.hithink_auction_snapshot DROP CONSTRAINT IF EXISTS ck_auction_snapshot_node_seq;
ALTER TABLE market.hithink_auction_snapshot ADD CONSTRAINT IF NOT EXISTS ck_auction_snapshot_node_seq CHECK node_seq BETWEEN 1 AND 11 OR (trade_date < toDate('2026-09-14') AND node_seq BETWEEN 251 AND 254) OR (trade_date >= toDate('2026-09-14') AND node_seq BETWEEN 250 AND 254);
ALTER TABLE market.hithink_auction_snapshot DROP CONSTRAINT IF EXISTS ck_auction_snapshot_closing_254;
ALTER TABLE market.hithink_auction_snapshot ADD CONSTRAINT IF NOT EXISTS ck_auction_snapshot_closing_254 CHECK node_seq != 254 OR (trade_date < toDate('2026-09-04') AND toHour(scheduled_time) = 15 AND toMinute(scheduled_time) = 0 AND toSecond(scheduled_time) = 0) OR (trade_date >= toDate('2026-09-04') AND trade_date < toDate('2026-09-14') AND toHour(scheduled_time) = 15 AND toMinute(scheduled_time) = 0 AND toSecond(scheduled_time) = 8) OR (trade_date >= toDate('2026-09-14') AND toHour(scheduled_time) = 15 AND toMinute(scheduled_time) = 30 AND toSecond(scheduled_time) = 8);
